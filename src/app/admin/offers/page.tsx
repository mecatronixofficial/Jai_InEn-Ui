              ...
              <AdminCard key={o.id} className="p-6">
                <div className="flex items-start justify-between mb-3">
                  <span className={cn(
                    ...
                    expired ? "bg-red-100 text-red-700" : "bg-gold/20 text-gold-dark",
                  )}>
                    <FaTag className="h-2.5 w-2.5" />
                    {expired ? "Expired" : `${o.discountPercent}% off`}
                  </span>
                ...
                {o.code && (
                  <div className="mt-3 inline-flex items-center gap-2 rounded-lg border border-dashed border-cream-300 px-3 py-1.5 text-xs">
                    Code: <span className="font-bold text-gold-dark">{o.code}</span>
                  </div>
                )}
