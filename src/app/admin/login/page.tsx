    ...
    <div className="min-h-screen grid lg:grid-cols-5 bg-cream-50">
      ...
      <div className="hidden lg:flex lg:col-span-2 relative bg-maroon-950 text-cream-50 overflow-hidden">
        ...
        <div className="relative flex flex-col justify-between p-12 w-full">
          <BrandLogo />
          <div>
            <div className="text-[11px] uppercase tracking-widest-x text-gold-light font-semibold mb-4 flex items-center gap-2">
              <span className="h-px w-8 bg-gold" /> Welcome back
            </div>
          ...
          {step === "login" && (
            <>
              ...
              <form onSubmit={handleLogin} className="mt-10 space-y-5">
                <div>
                  <label className="block text-[11px] uppercase tracking-widest-x text-gold-dark font-semibold mb-2">Email</label>
                ...
                <div>
                  <label className="block text-[11px] uppercase tracking-widest-x text-gold-dark font-semibold mb-2">Password</label>
                  <div className="relative">
          ...
          {step === "otp" && (
            <>
              ...
              <form onSubmit={handleVerifyOtp} className="mt-10 space-y-6">
                <div>
                  <label className="block text-[11px] uppercase tracking-widest-x text-gold-dark font-semibold mb-4">One-time code</label>
          ...
          {step === "reset" && (
            <>
              ...
              <form onSubmit={handleReset} className="mt-10 space-y-5">
                <div>
                  <label className="block text-[11px] uppercase tracking-widest-x text-gold-dark font-semibold mb-2">New password</label>
                  <div className="relative">
                    <FaLock className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-ink-muted" />
                    <input
                      type="password"
                ...
                <div>
                  <label className="block text-[11px] uppercase tracking-widest-x text-gold-dark font-semibold mb-2">Confirm password</label>
                  <div className="relative">
                    <FaLock className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-ink-muted" />
                    <input
                      type="password"
